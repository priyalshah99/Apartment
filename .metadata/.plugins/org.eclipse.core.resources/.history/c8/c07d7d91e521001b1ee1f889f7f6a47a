...
public class EmployeePositionController {
	...
	@GetMapping("/fetch/{id}")
	public EmployeePositionResponse getEmployeePosition(@PathVariable final long id) {
		return EmployeePositionResponse.build(employeePositionService.fetchEmployeePosition(id));
	}
